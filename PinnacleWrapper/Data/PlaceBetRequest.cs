...
namespace PinnacleWrapper.Data
{
    public class PlaceBetRequest
    {
        ...
        // Chosen side. This is needed only for TOTAL_POINTS and TEAM_TOTAL_POINTS bet type
        ...
        // Baseball only. Refers to the pitcher for TEAM_TYPE.Team1. This applicable only for MONEYLINE bet type, for all other bet types this has to be TRUE
